			...
			<Box position="relative" zIndex={20} maxWidth={1200} mx="auto">
				<div className="text-center">
					<h1 className="uppercase mb-3 text-2xl text-white">
						ХАУС ЗАХИАЛАХ{' '}
						<span className="font-semibold">ХҮСЭЛТ</span>
					</h1>
              ...
              lineHeight: {
                ...
                sm: '1.3'
					...
					>
						Та манай “Homey Mortgage”-ээс өөрийн мөрөөдлийн
						амины орон сууцаа худалдан авах зээлд хамрагдах
						боломжтой эсэхээ доорх хүсэлтийг бөглөн
						шалгуулаарай. Хүсэлтийг илгээснээр манай зээлийн
						мэргэжилтэн тантай холбогдох болно.
					</Typography>
					<Link href="/">
						<a className=" my-auto">
